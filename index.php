...
<body id="page-top" class="eupopup eupopup-top">
    ...
    <section id="progetti">
        ...
        <div class="container">
		    ...
		    <a href="https://cf.matteocastagnaro.it" class="btn btn-primary btn-xl wow rubberBand">Calcolalo subito online! <i class="fa fa-download"></i></a>
                </div>
